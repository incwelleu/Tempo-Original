<?php
  ...
  define(btnAmtSmall, "Annuler: montant trop petit");
	...
	define(btnCreateCreditNote, utf8_encode("Créer une facture de crédit"));
	define(btnSendEmailUnpaid, utf8_encode("Envoyer un e-mail NON PAYÉ"));
	define(btnSendEmailUnpaid2, utf8_encode("Envoyer un e-mail NON PAYÉ2"));
  ...
  define(SW_CAPTION_LAST_INVOICE, utf8_encode('Dernière facture:'));
  define(SW_CAPTION_STATUS, 'Statut:');
  ...
  define(SW_ERROR_DELETE_COMPANY_INVOICE, utf8_encode("La société ne peut pas être supprimée car elle a des factures liées (émises ou reçues)"));
