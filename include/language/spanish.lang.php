...
define(btnSendEmailUnpaid, "Enviar correo electrónico NO PAGADO");
define(btnSendEmailUnpaid2, utf8_encode("Enviar correo electrónico NO PAGADO"));
...
define(SW_CAPTION_LAST_INVOICE, utf8_encode('Última factura:'));
define(SW_CAPTION_STATUS, 'Estado:');
...
define(SW_ERROR_DELETE_COMPANY_INVOICE, utf8_encode("La empresa no se puede eliminar porque tiene facturas vinculadas (emitidas o recibidas)"));
